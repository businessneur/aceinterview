...
async def start_voice_interview(request: VoiceInterviewStartRequest):
    ...
    try:
        ...
        if room_name and agent_token:
            ...
            #lkapi = api.LiveKitAPI(url=os.getenv("LIVEKIT_WS_URL"))
            lkapi = api.LiveKitAPI(url=os.environ.get("LIVEKIT_URL"))
        ...
        import traceback
        print("Error in /api/voice-interview/start:", e)
...
if __name__ == "__main__":
    ...
    print_top_memory()  # Print top memory allocations on startup
    logger.info("AI Interview Platform started successfully")